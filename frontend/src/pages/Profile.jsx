...
const Profile = () => {
    ...
    const addPost = async (formData) => {
        try {
            const res = await fetch(`/profile/createPost`, {
                method: 'POST',
                credentials: 'include',
                body: formData
            })
    ...
    const followUser = async (userId) => {
        try {
            const res = await fetch(`/profile/followUser/${userId}`,{
                method: 'PUT',
                credentials: 'include',
            })
            const data = await res.json()
    ...
    const unfollowUser = async (userId) => {
        try {
            const res = await fetch(`/profile/unfollowUser/${userId}`,{
                method: 'PUT',
                credentials: 'include',
            })
            const data = await res.json()
    ...
    const likePost = async (postId) => {
        try {
            const res = await fetch(`/profile/likePost/${postId}`,{
                method: 'PUT',
                credentials: 'include',
            })
    ...
    const unlikePost = async (postId) => {
        try {
            const res = await fetch(`/profile/minusLikePost/${postId}`,{
                method: 'PUT',
                credentials: 'include',
            })
    ...
    const deletePost = async (postId) => {
        try {
            const res = await fetch(`/profile/deletePost/${postId}`, {
                method: 'DELETE',
                credentials: 'include',
            })
    ...
    const addComment = async(comment, postId) => {
        try {
            const res = await fetch(`/profile/comments/${postId}`,{
                method: 'POST',
                credentials: 'include',
                headers: {
    ...
    const uploadPhoto = async (formData) => {
        try {
            const res = await fetch(`/profile/uploadProfilePhoto`, {
                method: 'PUT',
                credentials: 'include',
                body: formData
            })
    ...
    const changePhoto = async (formData) => {
        try {
            const res = await fetch(`/profile/changeProfilePhoto`, {
                method: 'PUT',
                credentials: 'include',
                body: formData
            })
